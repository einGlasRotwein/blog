...
stimuli %>% 
  ...
  count() %>% 
  pull(n) %>% 
  all(. == 130) # check whether all counts == 130
```
...
stimuli %>% 
  ...
  count() %>% 
  pull(n) %>% 
  all(. == 65) # check whether all counts == 65
```
...
stimuli %>% 
  ...
  count() %>%
  pull(n) %>% 
  all(. == 10) # check whether all counts == 10 
```
...
stimuli %>% 
  ...
  count() %>% 
  pull(n) %>% 
  all(. == 130) # check whether each participant sees 130 unique stimuli
```
